...
tag to tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        My favorite recipe - Tomato and Egg Stir-Fry:
        <ol id="wd-Tomato and Egg Stir-Fry-recipe">
                <li>Crack and beat the eggs.</li>
                <li>Fry the eggs.</li>
                <li>Cook the tomatoes.</li>
                <li>Combine eggs and tomatoes.</li>
                <li>Serve hot.</li>      
...
Your favorite books (in no particular order)
        ...
        Please <a href="https://github.com/Wyf09140/2025su_CS5610" id="wd-github">click here</a> to get my code repository on GitHub<br/>
        </div>
